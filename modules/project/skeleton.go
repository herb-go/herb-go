...
var HTTPSkeleton = func(mp string) map[string]string {
	return map[string]string{
		...
		"/system/configskeleton/http.toml":          "/skeleton/system/configskeleton/http.toml",
		"/config/csrf.toml":                         "/skeleton/config/csrf.toml",
		"/system/defaultconfig/csrf.toml":           "/skeleton/system/defaultconfig/csrf.toml",
		"/system/defaultconfig//examples/csrf.toml": "/skeleton/system/defaultconfig/examples/csrf.toml",
		...
		mp + "/middlewares/factory.go":              "/skeleton/src/vendor/modules/middlewares/factory.go",
		...
		mp + "/overseers/action.go":                 "/skeleton/src/vendor/modules/overseers/action.go",
		mp + "/overseers/router.go":                 "/skeleton/src/vendor/modules/overseers/router.go",
		mp + "/overseers/middleware.go":             "/skeleton/src/vendor/modules/overseers/middleware.go",
	}
}
...
var WebsiteSkeleton = func(mp string) map[string]string {
	return map[string]string{
		"/system/defaultconfig/website.toml":          "/skeleton/system/defaultconfig/website.toml",
		"/system/defaultconfig/examples/website.toml": "/skeleton/system/defaultconfig/examples/website.toml",
